...
namespace test\craftformsubmissionspull\records;
...
/**
 * CraftFormSubmissionsPullRecord Record
 *
 ...
 * @since     1.0.0
 */
class CraftFormSubmissionsPullRecord extends ActiveRecord
{
    ...
    {
        return '{{%craftformsubmissionspull_craftformsubmissionspullrecord}}';
    }
}
